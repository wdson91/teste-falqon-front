        ...
        <Box>
            <form onSubmit={handleSubmit}>
                <Flex w={{ base: '90%', sm: '90%', md: '90%', lg: '60%', xl: '50%' }} m={'auto'} alignItems={'center'} gap={'20px'}>
                    ...
                    <Input value={description} onChange={(e) => setDescription(e.target.value)} focusBorderColor='none' border={'none'} borderBottom={'1px inset'} color={'gray.300'} m={'20px 0'} type='text' placeholder='Add a description...' />
